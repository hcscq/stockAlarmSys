...
namespace stockAlarmSys.Models.Mapping
{
    public class stock_alarm_GSAMap : EntityTypeConfiguration<stock_alarm_GSA>
    {
        ...
        {
            // Primary Key
            this.HasKey(t => new { t.ID});//, t.spid, t.spbh, t.hw, t.alarm_type, t.threshold_value, t.add_date, t.stock_5DLatter, t.last_alarmDate, t.alarm_state, t.saledIn1Month, t.saledIn1Month, t.lastCalcuDate 
